	...
	json_encode(
		array(
			array(
				...
				'text' => esc_html__( 'Lorem Ipsum','shop-isle' ),
				'subtext' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus feugiat, molestie ipsum et, consequat nibh. Etiam non elit dui. Nullam vel eros sit amet arcu vestibulum accumsan in in leo.','shop-isle' ),
				'link' => esc_html__( '#','shop-isle' ),
			),
			array(
				'icon_value' => 'icon_pin',
				'text' => esc_html__( 'Lorem Ipsum','shop-isle' ),
