...
class Shop_Isle_Repeater_Controler extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->boxtitle   = __( 'Cusomizer Repeater','shop-isle' );
		if ( ! empty( $this->label ) ) {
	...
	?>
		<div class="social-repeater-general-control-icon" <?php if ( $show === 'shop_isle_image' || $show === 'shop_isle_none' ) { echo 'style="display:none;"'; } ?>>
			...
			<span class="description customize-control-description">
				<?php
				echo sprintf(
	                __( 'Note: Some icons may not be displayed here. You can see the list of icons %1$s', 'shop-isle' ),
			...
			<div class="customizer-repeater-social-repeater">
				<div class="customizer-repeater-social-repeater-container">
					...
					<input type="text" class="customizer-repeater-social-repeater-link"
					       placeholder="<?php esc_html_e( 'Link', 'shop-isle' ); ?>">
					...
					<div class="customizer-repeater-social-repeater-container">
						...
						<button class="social-repeater-remove-social-item"
						        style="<?php if ( $show_del == 1 ) {
							        echo 'display:none';
} ?>"><?php esc_html_e( 'X', 'shop-isle' ); ?></button>
					</div>
					<?php
				} ?>
