...
function shopisle_theme_info_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'shopisle_pro_features_section', array(
			'title'    => __( 'View PRO Features', 'shop-isle' ),
			'priority' => 0,
		)
	);
	...
	$wp_customize->add_control( new Shopisle_Control_Upsell( $wp_customize, 'shopisle_upsell_pro_features_main', array(
				...
				'options'      => array(
					...
					esc_html__( 'Add New Section', 'shop-isle' ),
					esc_html__( 'Map Section', 'shop-isle' ),
					esc_html__( 'Services Section', 'shop-isle' ),
					esc_html__( 'Quick View functionality', 'shop-isle' ),
					esc_html__( 'Product Categories Section', 'shop-isle' ),
					esc_html__( 'Quality Support', 'shop-isle' ),
				),
